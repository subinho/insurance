    ...
    @foreach($insurances as $insurance)
      ...
      <div class="row mb-4">
        <x-form-field class="col-md-6">
          ...
          <x-form-input type="text" name="first_name" class="bg-readonly" id="first_name" placeholder="First name" pattern="[a-zA-Z]{3,50}" :value="$insurance->first_name" readonly/>
        </x-form-field>

        <x-form-field class="col-md-6">
          <x-form-label for="last_name">Last name</x-form-label>
          <x-form-input type="text" name="last_name" class="bg-readonly" id="last_name" placeholder="Last name" minlength="3" maxlength="50" pattern="[a-zA-Z]{3,50}" :value="$insurance->last_name" readonly/>
        </x-form-field>
      </div>
      ...
      <div class="row mb-4">
        <x-form-field class="col-md-6">
          ...
          <x-form-input type="email" name="email" class="bg-readonly" id="email" placeholder="example@mail.com" :value="$insurance->email" readonly/>
        </x-form-field>
        <x-form-field class="col-md-6">
